...
The `SpeakerSelection` component renders a `Select FormField` with audio output source options and the selected audio output provided by the `useAudioOutputs` hook.
